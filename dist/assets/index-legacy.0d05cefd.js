;(function(){function _slicedToArray(arr,i){return _arrayWithHoles(arr)||_iterableToArrayLimit(arr,i)||_unsupportedIterableToArray(arr,i)||_nonIterableRest();}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");}function _unsupportedIterableToArray(o,minLen){if(!o)return;if(typeof o==="string")return _arrayLikeToArray(o,minLen);var n=Object.prototype.toString.call(o).slice(8,-1);if(n==="Object"&&o.constructor)n=o.constructor.name;if(n==="Map"||n==="Set")return Array.from(o);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return _arrayLikeToArray(o,minLen);}function _arrayLikeToArray(arr,len){if(len==null||len>arr.length)len=arr.length;for(var i=0,arr2=new Array(len);i<len;i++){arr2[i]=arr[i];}return arr2;}function _iterableToArrayLimit(arr,i){var _i=arr==null?null:typeof Symbol!=="undefined"&&arr[Symbol.iterator]||arr["@@iterator"];if(_i==null)return;var _arr=[];var _n=true;var _d=false;var _s,_e;try{for(_i=_i.call(arr);!(_n=(_s=_i.next()).done);_n=true){_arr.push(_s.value);if(i&&_arr.length===i)break;}}catch(err){_d=true;_e=err;}finally{try{if(!_n&&_i["return"]!=null)_i["return"]();}finally{if(_d)throw _e;}}return _arr;}function _arrayWithHoles(arr){if(Array.isArray(arr))return arr;}function asyncGeneratorStep(gen,resolve,reject,_next,_throw,key,arg){try{var info=gen[key](arg);var value=info.value;}catch(error){reject(error);return;}if(info.done){resolve(value);}else{Promise.resolve(value).then(_next,_throw);}}function _asyncToGenerator(fn){return function(){var self=this,args=arguments;return new Promise(function(resolve,reject){var gen=fn.apply(self,args);function _next(value){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"next",value);}function _throw(err){asyncGeneratorStep(gen,resolve,reject,_next,_throw,"throw",err);}_next(undefined);});};}function _typeof(obj){"@babel/helpers - typeof";return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(obj){return typeof obj;}:function(obj){return obj&&"function"==typeof Symbol&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;},_typeof(obj);}var __vite_style__=document.createElement('style');__vite_style__.innerHTML=".demo{font-size:60rpx;color:red}\n";document.head.appendChild(__vite_style__);System.register(['./vendor-legacy.44f98a50.js','./index-legacy.be3ee0bf.js'],function(exports){'use strict';var commonjsGlobal,normalizeComponent;return{setters:[function(module){commonjsGlobal=module.c;},function(module){normalizeComponent=module.n;}],execute:function execute(){var jquery={exports:{}};/*!
			 ...
			 */(function(module){(function(global,factory){{// For CommonJS and CommonJS-like environments where a proper `window`
...
})(typeof window!=="undefined"?window:commonjsGlobal,function(window,noGlobal){var arr=[];var getProto=Object.getPrototypeOf;var _slice=arr.slice;var flat=arr.flat?function(array){return arr.flat.call(array);}:function(array){return arr.concat.apply([],array);};var push=arr.push;var indexOf=arr.indexOf;var class2type={};var toString=class2type.toString;var hasOwn=class2type.hasOwnProperty;var fnToString=hasOwn.toString;var ObjectFunctionString=fnToString.call(Object);var support={};var isFunction=function isFunction(obj){// Support: Chrome <=57, Firefox <=52
...
!isNaN(obj-parseFloat(obj));};jQuery.trim=function(text){return text==null?"":(text+"").replace(rtrim,"");};var// Map over jQuery in case of overwrite
_jQuery=window.jQuery,// Map over the $ in case of overwrite
_$=window.$;jQuery.noConflict=function(deep){if(window.$===jQuery){window.$=_$;}if(deep&&window.jQuery===jQuery){window.jQuery=_jQuery;}return jQuery;};// Expose jQuery and $ identifiers, even in AMD
// (#7102#comment:10, https://github.com/jquery/jquery/pull/557)
// and CommonJS for browser emulators (#13566)
if(typeof noGlobal==="undefined"){window.jQuery=window.$=jQuery;}return jQuery;});})(jquery);function base(options){var origin="http://localhost:3422";if(options.url[0]=="/"){options.url=origin+options.url;}if(options.method!=="GET"&&options.headers['Content-Type']===''){options.headers['Content-Type']='application/json';options.dataType='json';}if(!options.data){options.data={};}return new Promise(/*#__PURE__*/function(){var _ref=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee(resolve){return regeneratorRuntime.wrap(function _callee$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:jquery.exports.ajax(options).done(function(resp){resp.error=resp.error||{code:0,message:""};if(resp.error.code===0){// 不要从 resp.error 获取错误信息,而是 从 const [resp,err] = await some() 的 err 获取信息
delete resp.error;resolve([resp,null]);}else{var err=resp.error;// 不要从 resp.error 获取错误信息,而是 const [resp,err] = await some()
delete resp.error;resolve([resp,err]);}}).fail(function(){resolve([{},{code:1,message:"网络错误"}]);});case 1:case"end":return _context2.stop();}}},_callee);}));return function(_x){return _ref.apply(this,arguments);};}());}function eaxmpleNews(_x2){return _eaxmpleNews.apply(this,arguments);}function _eaxmpleNews(){_eaxmpleNews=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee3(data){return regeneratorRuntime.wrap(function _callee3$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:return _context4.abrupt("return",base({method:"GET",url:"/news",data:data}));case 1:case"end":return _context4.stop();}}},_callee3);}));return _eaxmpleNews.apply(this,arguments);}var main={data:function data(){return{title:'demo'};},onLoad:function onLoad(){}};var render$1=function render$1(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',{staticClass:"demo"},[_vm._v(_vm._s(_vm.title))]);};var staticRenderFns$1=[];var index_vue_vue_type_style_index_0_lang$1='';//
var __vue2_script$1=main;var __cssModules$1={};var __component__$1=/*#__PURE__*/normalizeComponent(__vue2_script$1,render$1,staticRenderFns$1,false,__vue2_injectStyles$1,null,null,null);function __vue2_injectStyles$1(context){for(var o in __cssModules$1){this[o]=__cssModules$1[o];}}var Demo=/*#__PURE__*/function(){return __component__$1.exports;}();var render=function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"title"},[_vm._v("home")]),_c('el-button',{on:{"click":_vm.clickButton}},[_vm._v(_vm._s(_vm.$store.state.exampleCount))]),_c('el-button',{on:{"click":_vm.sendRequest}},[_vm._v("send ajax")]),_c('hr'),_c('Demo')],1);};var staticRenderFns=[];var index_vue_vue_type_style_index_0_lang='';//
var __vue2_script={components:{Demo:Demo},methods:{clickButton:function clickButton(){var vm=this;vm.$store.commit("exampleIncrement");},sendRequest:function(){var _sendRequest=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee2(){var vm,_yield$eaxmpleNews,_yield$eaxmpleNews2,resp,err;return regeneratorRuntime.wrap(function _callee2$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:vm=this;_context3.next=3;return eaxmpleNews();case 3:_yield$eaxmpleNews=_context3.sent;_yield$eaxmpleNews2=_slicedToArray(_yield$eaxmpleNews,2);resp=_yield$eaxmpleNews2[0];err=_yield$eaxmpleNews2[1];if(!err){_context3.next=10;break;}vm.$message(err.m.eaxmpleNeessage);return _context3.abrupt("return");case 10:console.log(resp);case 11:case"end":return _context3.stop();}}},_callee2,this);}));function sendRequest(){return _sendRequest.apply(this,arguments);}return sendRequest;}()},data:function data(){return{};}};var __cssModules={};var __component__=/*#__PURE__*/normalizeComponent(__vue2_script,render,staticRenderFns,false,__vue2_injectStyles,null,null,null);function __vue2_injectStyles(context){for(var o in __cssModules){this[o]=__cssModules[o];}}var index=exports('default',/*#__PURE__*/function(){return __component__.exports;}());}};});})();
